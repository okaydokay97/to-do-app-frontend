    ...
    return(
      <div className="text-center">
        ...
        <form onSubmit={this.handleSubmit}>
          <label>Task Title:<br/>
            <input onChange={this.handleTitleChange} type="text" name="title" placeholder="Title"></input><br/>
          </label>
          <div></div>
          <label>Task Description:<br/>
            <textarea onChange={this.handleDescriptionChange} type="text" name="title" placeholder="Description"></textarea><br/>
          </label>
          <div></div>
